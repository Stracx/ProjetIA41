...
ligne(_,_,[],4,S,0) :- S is 2500,ligne(_,_,_,_,_,1),!.
...
ligne(_,_,[],(-2),S,0) :- S is (-50),ligne(_,_,_,_,_,1),!.
ligne(_,_,[],(-3),S,0) :- S is (-100),ligne(_,_,_,_,_,1),!.
ligne(_,_,[],(-4),S,0) :- S is (-500),ligne(_,_,_,_,_,1),!.

ligne([],[],_,4,S,0) :- S is 2500, ligne(_,_,_,_,_,1),!.
...
ligne([],[],_,(-2),S,0) :- S is (-50),ligne(_,_,_,_,_,1),!.
ligne([],[],_,(-3),S,0) :- S is (-100),ligne(_,_,_,_,_,1),!.
ligne([],[],_,(-4),S,0) :- S is (-500),ligne(_,_,_,_,_,1),!.
