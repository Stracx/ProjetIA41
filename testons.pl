...
ligne(_,_,[],4,S,0) :- S is 5000,ligne(_,_,_,_,_,1),!.
ligne(_,_,[],3,S,0) :- S is 250, ligne(_,_,_,_,_,1),!.
...
ligne([],[],_,4,S,0) :- S is 5000, ligne(_,_,_,_,_,1),!.
ligne([],[],_,3,S,0) :- S is 250,ligne(_,_,_,_,_,1),!.
